...
class MyAudioCaptureEventHandler(AudioCaptureEventHandler):
    def __init__(self, client: RealtimeAIClient, event_handler: "MyRealtimeEventHandler"):
        ...
        self._silence_timeout = 10  # Configurable silence timeout in seconds for rearming keyword detection
...
def main():
    ...
    try:
        ...
        options = RealtimeAIOptions(
            ...
            instructions="You are a helpful assistant. Respond concisely. You have following functions to take screenshot 1) take_screenshot_and_save 2) take_screenshot_and_analyze",
